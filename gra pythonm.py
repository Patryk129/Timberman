...
def Menu():
    ...
    UstawCursor(xt+3,yt+63)
    print(kolor + "Najlepszy Wynik:",najlepszy)
    UstawCursor(xt+5,yt+3)
    print(kolor + "Zmień kolor gry: Kliknij L")
    UstawCursor(xt+5,yt+63)
    print(kolor + "Kolor początkowy: Kliknij R")
    UstawCursor(xt+7,yt+3)
    print(kolor + "Poruszanie się: A / D")
    UstawCursor(xt+7,yt+63)
    print(kolor + "Lub: <- / ->")
    UstawCursor(xt+9,yt+40)
    print(kolor + "Graj:  Kliknij SPACE")
